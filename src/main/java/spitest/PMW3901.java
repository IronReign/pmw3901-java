...
public class PMW3901 {
    ...
    public PMW3901(int spi_port, int spi_cs, int spi_cs_gpio) {
        ...
        try {
            spi_dev = SpiFactory.getInstance(SpiChannel.CS0,
            400000, // default spi speed 1 MHz
        ...
        write(REG_POWER_UP_RESET, (byte) 0x5a);
        try {
            Thread.sleep(20);
        } catch (InterruptedException e) {
            // TODO Auto-generated catch block
        ...
        for(int offset = 0; offset < 5; offset++)
            read((byte) (REG_DATA_READY + offset));
